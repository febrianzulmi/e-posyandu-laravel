                ...
                <div class="card-body">
                    <form action="{{ url('/login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control font-size-14 rounded-0" name="username" id="username"
                                placeholder="Username" value="{{ old('username') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="font-size-14 form-label">Password</label>
                            <input type="password" class="form-control font-size-14 rounded-0" name="password"
                                id="password" placeholder="Password" required>
                        </div>
                        <div class="mb-3 text-end">
                            <button type="submit"
                                class="btn btn-sm btn-danger rounded-0 font-size-14 font-weight-bold">Login</button>
                        </div>
                    </form>
                </div>
            </div>
